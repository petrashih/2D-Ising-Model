...
nt      = 45         #  number of temperature points
N       = 24         #  size of the lattice, N x N
eqSteps = 60000       #  number of MC sweeps for equilibration
mcSteps = 200000       #  number of MC sweeps for calculation

FileEnergy = "Data_Energy_fast_L24_45pt.txt"
FileMagnet = "Data_Magnet_fast_L24_45pt.txt"
FileC = "Data_SpHeat_fast_L24_45pt.txt"
FileX = "Data_Suscep_fast_L24_45pt.txt"
FileFigure = "Fig_total_fast_L24_45pt.png"


T       = np.linspace(0.015, 4.5, nt); 
